...
"""
Functions for printing processing time.
...
At the start of each major step, the current time is stored in a new variable, using start_processing() function. 
At the end of each major stepn, the print_processing_time(begintime, printmessage) function is called and takes as argument the variable 
containing the recorded time at the start of the stage, and an output message.
"""
